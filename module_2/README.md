...
1. Этап 1. Загрузка данных и первичный осмотр
2. Этап 2. Первичный анализ данных в столбцах
3. Этап 3. Корреляционный анализ числовых переменных
4. Этап 4. Анализ номинативных переменных
5. Этап 5. Обработка данных. Устранение пропусков и выбросов
6. Этап 6. Подготовка данных к использованию в моделе
